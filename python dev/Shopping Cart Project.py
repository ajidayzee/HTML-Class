#Shopping Cart
#To show creativity I added better formatting and also added quantity of the items in the list.
...
#loop for choice 3
while choice != 1 and choice != 2 and choice != 4 and choice != 5:
    item = int(input('Which item would you like to remove?  '))
    #cost = input(f"What is the price of '{item}'?  ")
    
    if choice != 1 and choice != 2 and choice != 4 and choice != 5:
        shopping_cart.pop(item - 1)
        quantity.pop(item - 1)
        prices.pop(item - 1)
...
while choice != 1 and choice != 2 and choice != 3 and choice != 5:
    if choice != 1 and choice != 2 and choice != 3 and choice != 5:
